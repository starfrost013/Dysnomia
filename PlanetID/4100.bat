...
set PlanetName=Proxima b
:: planet name
set PlanetSizeKM=2440
:: planet size (KM)
set PlanetGravity=1.27
...
set PlanetOrbitalRadius=7625450 :: Distance from star to planet [SMA]
set PlanetStar=4
:: for use by StarID?
set PlanetNumber=1 
:: closest planet
...
set Albedo=0.38
:: albedo
set EnviromentType=coldearth
(grassy, earth, hell, icy, water-icy, gassy, etc)
set RocheLimit=38000
